...
def create_app(debug=False):
    ...
    db.createUser(email='admin@email.com', password='password', role='admin', tokens=100)
    db.createUser(email='guest@email.com', password='password', role='guest', tokens=100)
    db.createUser(email='owner@email.com', password='password', role='owner', tokens=100)
    # ----------------------------------------------
